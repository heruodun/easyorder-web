...
public class WaveController {
    ...
    @GetMapping("/mobile/order/wave/list")
    ...
    @GetMapping("/mobile/order/wave/get/{waveId}")
    ...
    @GetMapping("/mobile/order/wave/queryByOrder/{orderId}")
    ...
    @PostMapping("/mobile/order/wave/create")
    ...
    @PostMapping("/mobile/order/wave/ship")
    ...
    @PostMapping("/mobile/order/wave/order/addOrDel")
