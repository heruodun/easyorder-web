...
const addMaterialCategory = (params) => postAction('/materialCategory/add', params);
const updateMaterialCategory = (params) => putAction('/materialCategory/update', params);
const deleteMaterialCategory = (params) => deleteAction('/materialCategory/delete', params);
