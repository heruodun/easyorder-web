...
<script setup>
  ...
  import { printProductionBox, printT1 } from '/@/lib/smart-print.js';
  ...
  function handleKeyPress(event) {
    if ('#/business/order/production/dadan_bag' == activeTabStore().getActive() && (event.ctrlKey || event.metaKey) && event.key === 'p') {
