...
//     path: '/',
//     name: '首页',
//     component: Vue.defineAsyncComponent(() => import('/@/components/layouts/TabLayout')),
//     meta: {
//       title: '首页',
//       icon: 'icon-present',
...
//       componentPath = Vue.defineAsyncComponent(() => import('@/components' + item.component));
//     } else {
//       componentPath = Vue.defineAsyncComponent(() => import('@/views' + item.component));
//     }
...
export function getNowFormatDateTime() {
  ...
  return date.getFullYear() + seperator1 + month + seperator1 + strDate + ' ' + strHours + seperator2 + strMinutes + seperator2 + strSeconds;
}
