  ...
  <div class="back-layout">
    ...
    <div class="footer" v-if="device === 'desktop'">
      ...
      <p>
        ...
        <a
          style="color: #00458a; padding-right: 10px"
          :href="systemUrl"
          target="_blank"
          >官方网站</a
        >
        <span v-if="this.isShowRight"
    ...
    <a-modal
      v-model:value="isIphoneShow"
      title="微信扫一扫下载iPhone版"
      width="200"
      centered
    >
      <template v-slot:footer>
      ...
      <div class="platform-modal">
        <img src="/static/iphone-code.png" style="width: 200px" />
      </div>
    </a-modal>
    <a-modal
      v-model:value="isMiniProgramShow"
      title="微信扫一扫使用小程序版"
      width="200"
      centered
    >
      ...
      <div class="platform-modal">
        <img src="/static/weixin-code.png" style="width: 200px" />
      </div>
    </a-modal>
  </div>
</template>
