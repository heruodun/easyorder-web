...
export default {
  ...
  methods: {
    updateSelect(selectedRowKeys, selectedRows) {
      ...
      $emit(this, 'change', selectedRowKeys, selectedRows)
    },
    ...
    loadData(params) {
      ...
      remoteParams[that.paramsName.pageNumber] =
        params.pageNum || that.pageNumber
      ...
      dataPromise.then(
        (response) => {
          ...
          $emit(that, 'update:currentData', that.current.slice())
          $emit(that, 'dataloaded', that.current.slice())
  ...
  emits: ['change', 'update:currentData', 'dataloaded'],
}
</script>
