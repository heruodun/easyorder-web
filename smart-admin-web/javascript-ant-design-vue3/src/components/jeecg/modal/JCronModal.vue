    ...
    <div class="card-container">
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          <template v-slot:tab>
            <span><a-icon type="schedule" /> 秒</span>
          </template>
        ...
        <a-tab-pane key="2">
          <template v-slot:tab>
            <span><a-icon type="schedule" />分</span>
          </template>
          <div class="tabBody">
        ...
        <a-tab-pane key="3">
          <template v-slot:tab>
            <span><a-icon type="schedule" /> 时</span>
          </template>
          <div class="tabBody">
        ...
        <a-tab-pane key="4">
          <template v-slot:tab>
            <span><a-icon type="schedule" /> 天</span>
          </template>
          <div class="tabBody">
        ...
        <a-tab-pane key="5">
          <template v-slot:tab>
            <span><a-icon type="schedule" /> 月</span>
          </template>
          <div class="tabBody">
        ...
        <a-tab-pane key="6">
          <template v-slot:tab>
            <span><a-icon type="schedule" /> 年</span>
          </template>
          <div class="tabBody">
