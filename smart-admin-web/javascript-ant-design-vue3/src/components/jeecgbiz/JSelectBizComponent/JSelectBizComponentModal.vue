<template>
  <a-modal centered :title="name + '选择'" :width="width" :open="visible" @ok="handleOk" @cancel="close" cancelText="关闭">
    <a-row :gutter="18">
      <a-col :span="16">
        <!-- 查询区域 -->
            ...
            <a-row :gutter="24">
              <a-col :span="14">
                <a-form-item :label="queryParamText || name">
                  <a-input
                    v-model:value="queryParam[queryParamCode || valueKey]"
      ...
      <a-col :span="8">
        <a-card :title="'已选' + name" :bordered="false" :head-style="{ padding: 0 }" :body-style="{ padding: 0 }">
          <a-table v-bind="selectedTable" size="small" :rowKey="rowKey" bordered>
  ...
  export default {
    ...
    methods: {
      ...
      emitOptions(dataSource, callback) {
        ...
        $emit(this, 'options', this.options, this.dataSourceMap);
      },
    ...
    emits: ['update:visible', 'options', 'update:value'],
  };
</script>
